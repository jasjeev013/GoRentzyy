...
public class BookingController {
    ...
    public ResponseEntity<ApiResponseObject> addBooking(@RequestBody BookingDto bookingDto, @PathVariable Long carId,@PathVariable Long renterId){
        return bookingService.createBooking(bookingDto,renterId,carId);
    }
    
    @PutMapping("/update/{bookingId}")
    public ResponseEntity<ApiResponseObject> updateBooking(@RequestBody BookingDto bookingDto,@PathVariable Long bookingId){
