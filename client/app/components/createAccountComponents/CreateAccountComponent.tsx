...
const CreateAccountComponent = ({ onClose }: CreateAccountProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Signup popup */}
      <div className="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 z-10 mx-4">
        {/* Close button */}
        <button
          onClick={onClose}
