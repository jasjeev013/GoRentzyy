...
const Navbar = ({ isScrolled }: { isScrolled: boolean }) => {
    return (
        <>
            <div className={`flex items-center justify-between animate-slide-down sticky z-50 transition-all duration-300 ${isScrolled ? 'bg-[#252A27CC] backdrop-blur-sm rounded-lg shadow-lg py-2 top-5 px-7 w-[calc(100%-40px)] mx-auto' : 'py-1 top-0 px-1 w-full'}`}>
